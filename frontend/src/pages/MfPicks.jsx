      ...
      <PageFooter sections={[
        {
          title: "Data Sources",
          items: [
            '<span class="text-gray-400">AMFI NAVAll.txt</span> — fund names &amp; scheme codes (24h cache)',
            '<span class="text-gray-400">mfapi.in</span> — daily NAV history per scheme (24h cache)',
            "GitHub Actions refreshes MF data at 5 AM IST daily · NAV lags by 1 trading day",
            "One best fund per category shown — same fund universe across all runs",
          ],
        },
        {
          title: "Composite Score (0–100)",
          items: [
            "Step 1 — Momentum base: 1W×25% · 1M×20% · 3M×15% · 6M×10% · 1Y×10% · 5Y CAGR×5% · Sharpe×5%",
            "Step 2 — z-score conviction multiplier ×0.55–1.00 (hot category = higher weight)",
            "Step 3 — Peer-normalise to 0–100 across all categories",
            "Step 4 — Blend 65% momentum score + 35% analyst verdict signal",
            "Low-confidence Buy → demoted to Watch; score reflects confidence level",
          ],
        },
        {
          title: "Analyst Verdict",
          items: [
            '<span class="text-green-400">Buy</span> — momentum &amp; macro signal aligned; medium/high confidence',
            '<span class="text-yellow-500">Watch / Hold</span> — mixed signals, low confidence, or recovering',
